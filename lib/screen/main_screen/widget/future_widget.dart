...
import 'package:cars_api/screen/car_details_screen/car_details_screen.dart';
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => CarDetails(
                              ...
                              seats: data.seats!.toInt(),
                              speed: data.speed!.toInt(),
                              engine: data.speed!.toInt()),
                        ));
                  },
                  child: Container(
                    width: 150,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: FavoriteItem(change: false),
                        ),
                        Container(
                          height: 140,
                          width: 200,
